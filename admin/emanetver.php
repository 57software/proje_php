...
<body>
    ...
    <div class="content" style="text-align: center; vertical-align: middle; max-width:100%; max-height:100%;">
        ...
        <div class="search-container">
            ...
            <form action="emanetver.php" method="post">
                        ...
                        <table border=1 cellpadding=10 cellspacing=0>
                            ...
                            try {
                                ...
                                if (isset($_POST['kitapAdi'])) {
                                    ...
                                    $sql_kitapAra = "SELECT tbl_yayin_evleri.yayinEviAdi, kategoriler.kategoriAdi, kitaplar_kutuphane.kutuphane_id, kitaplar_kutuphane.adet, yazarlar.yazarAd, yazarlar.yazarSoyad, tbl_kitaplar.ISBN, tbl_kitaplar.kitapAdi, tbl_kitaplar.yayinTarihi, tbl_kitaplar.sayfaSayisi, tbl_kitaplar.kitapDili FROM tbl_yayin_evleri, tbl_kitaplar, kitaplar_kutuphane, yazarlar, kategoriler WHERE tbl_yayin_evleri.yayinEvi_id = tbl_kitaplar.yayinEvi_id AND tbl_kitaplar.kitap_id = kitaplar_kutuphane.kitap_id AND yazarlar.kitap_id = tbl_kitaplar.kitap_id AND kategoriler.kitap_id = tbl_kitaplar.kitap_id
