...
<body>
    ...
    <!-- İçerik kısmı -->
    <div class="content" style="margin-left: 400px; text-align: center; vertical-align: middle; max-width:1000px; max-height:100%;">
        <br>
        ...
        <br><br>
        <div>
            <form action="yayinevi_ekle.php" method="post">
                <input type="text" name="yayineviAd" placeholder="Yayınevi Adı" required>
                ...
                <input type="submit" value="Yayınevi Ekle">
            </form>
        </div>
    </div>
    <script>
