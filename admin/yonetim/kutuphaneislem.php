...
<body>
    ...
    <div class="content" style="text-align: center; vertical-align: middle; max-width:100%; max-height:100%;">
        <br><br>
        <a href="kutuphanelistesi.php" class="custom-button">Kütüphane Listesi</a>&nbsp;&nbsp;
        <a href="kutuphane.php" class="custom-button">Kütüphane Ekle</a>
        <h1>Kütüphane Listesi</h1>
        <form action="kutuphaneislem.php" method="post">
            ...
            if (isset($_POST['kutuphane_arama'])) {
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<td>" . $row["ilce"] . "</td>";
                        echo "<td>" . $row["il"] . "</td>";
                        echo "<td><a href='kutuphaneguncelle.php?kutuphane_id=" . $row["kutuphane_id"] . "&kutuphaneAd=" . $row["kutuphaneAd"] . "&
                        ...
                        echo "<td><a href='kutuphanesil.php?kutuphane_id=" . $row["kutuphane_id"] . "&adres_id=" . $row["adres_id"] . "' class='custom-button1'>Sil</a></td>";
                        echo "</tr>";
                    }
                } else {
