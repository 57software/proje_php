...
<body>
    ...
    <div class="content" style="margin-left: 400px; text-align: center; vertical-align: middle; max-width:100%; max-height:100%;">
        ...
        <br><br>
        <div>
            <form action="kutuphaneguncelleok.php" method="post">
                <input type="text" name="kutuphane_id" placeholder="Kütüphane No" value="<?php echo $kutuphane_id; ?>" required>
                <input type="text" name="kutuphaneAd" placeholder="Kütüphane Adı" value="<?php echo $kutuphaneAd; ?>" required>
                ...
                <input type="submit" value="Kütüphane Güncelle">
            </form>
        </div>
    </div>
    <script>
