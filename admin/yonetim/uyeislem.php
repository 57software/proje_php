            ...
            if (isset($_POST['uye_arama'])) {
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<td><a href='uyeguncelle.php?uye_id=" . $row["uye_id"] . "&adres_id=" . $row["adres_id"] . "
                        &uyeAd=" . $row["uyeAd"] . "&uyeSoyad=" . $row["uyeSoyad"] . "&kullaniciAdi=" . $row["kullaniciAdi"] . "
                        &sifre=" . $row["sifre"] . "&cinsiyet=" . $row["cinsiyet"] . "&telefon=" . $row["telefon"] . "
                        &eposta=" . $row["eposta"] . "&yetki=" . $row["yetki"] . "&kayitTarihi=" . $row["kayitTarihi"] . "
                        &yasaklimi=" . $row["yasaklimi"] . "&mahalle=" . $row["mahalle"] . "&cadde=" . $row["cadde"] . "&sokak=" . $row["sokak"] . "
                        &binaNo=" . $row["binaNo"] . "&kapiNo=" . $row["kapiNo"] . "&ilce=" . $row["ilce"] . "&il=" . $row["il"] . "
                        ' class='custom-button'>Güncelle</a></td>";
                        echo "<td><a href='uyesil.php?kullaniciAdi=" . $row["kullaniciAdi"] . "&adres_id=" . $row["adres_id"] . "' class='custom-button1'>Sil</a></td>";
                        echo "</tr>";
                    }
                } else {
