            ...
            if (isset($_POST['uye_arama'])) {
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<td><a href='uyeyasakla.php?kullaniciAdi=" . $row["kullaniciAdi"] . "' class='custom-button1'>Yasakla</a></td>";
                        echo "<td><a href='uyeyasakkaldir.php?kullaniciAdi=" . $row["kullaniciAdi"] . "' class='custom-button'>Yasak Kaldır</a></td>";
                        echo "</tr>";
                    }
                } else {
