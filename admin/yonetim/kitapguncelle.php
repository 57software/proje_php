...
<body>
    ...
    $kategoriAdi = $_GET["kategoriAdi"];
    $kutuphane_id = $_GET["kutuphane_id"];
    $adet = $_GET["adet"];
    $yazarAd = $_GET["yazarAd"];
    $yazarSoyad = $_GET["yazarSoyad"];
    $ISBN = $_GET["ISBN"];
    $kitapAdi = $_GET["kitapAdi"];
    $yayinTarihi = $_GET["yayinTarihi"];
    $sayfaSayisi = $_GET["sayfaSayisi"];
    $kitapDili = $_GET["kitapDili"];

    $tarihDizi = explode(".", $yayinTarihi);
    $tarihDizi1 = $tarihDizi[2] . "-" . $tarihDizi[1] . "-" . $tarihDizi[0];
    $tarih = new DateTime($tarihDizi1);
    ...
    <div class="content" style="margin-left: 400px; text-align: center; vertical-align: middle; max-width:100%; max-height:100%;">
        ...
        <br><br>
        <div>
            <form action="kitapguncelleok.php" method="post">
                ...
                echo '<option value="' . $yayinEviAdi . '" disabled selected>' . $yayinEviAdi . '</option>';
                ...
                echo '<option value="' . $kategoriAdi . '" disabled selected>' . $kategoriAdi . '</option>';
                ...
                <br><br>
                <input type="hidden" name="kutuphaneID" placeholder="Kütüphane ID" value="<?php echo $kutuphane_id; ?>" required>
                <input type="text" name="kitapAdeti" placeholder="Kitap Adeti" value="<?php echo $adet; ?>" required>
                <input type="text" name="yazarAdi" placeholder="Yazar Adı" value="<?php echo $yazarAd; ?>" required>
                <input type="text" name="yazarSoyadi" placeholder="Yazar Soyadı" value="<?php echo $yazarSoyad; ?>" required>
                <input type="text" name="ISBN" placeholder="ISBN" value="<?php echo $ISBN; ?>" required>
                <input type="text" name="kitapAdi" placeholder="Kitap Adı" value="<?php echo $kitapAdi; ?>" required>
                <input type="date" name="yayinTarihi" placeholder="Yayın Tarihi" value="<?php echo $tarih->format('Y-m-d'); ?>" required>
                <input type="text" name="sayfaSayisi" placeholder="Sayfa Sayısı" value="<?php echo $sayfaSayisi; ?>" required>
                <input type="text" name="kitapDili" placeholder="Kitap Dili" value="<?php echo $kitapDili; ?>" required>
